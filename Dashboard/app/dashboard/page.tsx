...
export default function Dashboard() {
  ...
  return (
    <div className={`flex ${theme === "dark" ? "bg-black text-white" : "bg-gray-50 text-gray-900"}`}>
      {/* Mobile Sidebar Overlay */}
      {sidebarOpen && <div className="fixed inset-0 bg-black bg-opacity-50 z-40 lg:hidden" onClick={closeSidebar} />}

      {/* Sidebar */}
      <div
        className={`${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-50 w-64 ${
      ...
      >
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="flex items-center justify-between w-full mb-4">
              ...
              <Button
                variant="ghost"
                size="icon"
                className={`lg:hidden ${theme === "dark" ? "text-white" : "text-gray-700"}`}
            ...
            <button
              ...
              className={`flex items-center w-full px-4 py-3 text-sm rounded-md ${
                activeSection === "dashboard"
                  ? theme === "dark"
                    ? "bg-zinc-800 text-[#be9244]"
                    : "bg-[#143755] text-white"
                  : theme === "dark"
                    ? "text-zinc-400 hover:bg-zinc-800 hover:text-white"
                    : "text-gray-700 hover:bg-gray-100 hover:text-[#143755]"
              }`}
            >
              <svg
            ...
            <div>
              ...
              {coreExpanded && (
                <div className="ml-6 mt-1 space-y-1">
                  ...
                  >
                    <div
                      className={`w-2 h-2 rounded-full mr-3 ${theme === "dark" ? "bg-[#be9244]" : "bg-[#143755]"}`}
                    ></div>
                    Wallet Connection
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className={`flex items-center w-full px-4 py-2 text-sm rounded-md ${
                      activeSection === "gnosis-safe-status"
                        ? theme === "dark"
                          ? "text-[#be9244]"
                          : "text-[#143755]"
                        : theme === "dark"
              ...
              {stakingExpanded && (
                <div className="ml-6 mt-1 space-y-1">
                  ...
                  <button
                    ...
                    className={`flex items-center w-full px-4 py-2 text-sm rounded-md ${
                      activeSection === "protection-visualizer"
                        ? theme === "dark"
                          ? "text-[#be9244]"
                          : "text-[#143755]"
                        : theme === "dark"
              ...
              {claimsExpanded && (
                <div className="ml-6 mt-1 space-y-1">
                  ...
                  <button
                    ...
                    className={`flex items-center w-full px-4 py-2 text-sm rounded-md ${
                      activeSection === "aircraft-specific-form"
                        ? theme === "dark"
                          ? "text-[#be9244]"
                          : "text-[#143755]"
                        : theme === "dark"
                  ...
                  <button
                    ...
                    className={`flex items-center w-full px-4 py-2 text-sm rounded-md ${
                      activeSection === "pilot-log-integration"
                        ? theme === "dark"
                          ? "text-[#be9244]"
                          : "text-[#143755]"
                        : theme === "dark"
                  ...
                  <button
                    ...
                    className={`flex items-center w-full px-4 py-2 text-sm rounded-md ${
                      activeSection === "ai-validation-status"
                        ? theme === "dark"
                          ? "text-[#be9244]"
                          : "text-[#143755]"
                        : theme === "dark"
        ...
        <div className={`mt-auto p-4 border-t ${theme === "dark" ? "border-zinc-800" : "border-gray-200"}`}>
          <button
            onClick={handleLogout}
            className="flex items-center w-full px-4 py-3 text-sm text-red-500 hover:bg-zinc-800 rounded-md"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 mr-3"
        ...
        >
          ...
          <Button
            className={`text-sm px-3 py-1 ${
              theme === "dark"
                ? "bg-[#be9244] hover:bg-[#a67d3a] text-black"
                : "bg-[#143755] hover:bg-teal-600 text-white"
            }`}
          >
            Connect
          </Button>
    ...
    <div className="p-4 lg:p-8">
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-8 space-y-4 lg:space-y-0">
        ...
        <div className="flex items-center space-x-4">
          <div className="relative hidden lg:block">
            ...
            <Input
              placeholder="Search..."
              className={`pl-10 w-64 focus:border-[#be9244] focus:ring-[#be9244] ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        >
          ...
          <div className="space-y-4">
            <div>
              <p className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>Wallet Address:</p>
              <p className="text-sm font-mono break-all">0xabcdef1234567890ab...</p>
            </div>
            <div>
              <p className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>Staking Status:</p>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>Your Tier:</p>
            ...
            <div>
              ...
              <Progress
                value={25}
                className={`h-2 ${theme === "dark" ? "bg-zinc-800" : "bg-gray-200"}`}
        ...
        >
          ...
          <div className="space-y-4">
            <div>
              <p className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>Coverage Limit:</p>
              <p className="text-sm">$150K</p>
            </div>
            <div>
              <p className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>Aircraft Risk Rating:</p>
              <p className={`text-sm ${theme === "dark" ? "text-[#be9244]" : "text-amber-500"}`}>Low</p>
            </div>
            <div className="mt-4">
        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex items-baseline">
              <span className={`text-xl font-bold ${theme === "dark" ? "text-[#be9244]" : "text-amber-500"}`}>85</span>
              <span className={`ml-1 ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>/ 100</span>
            </div>
            <p className="text-sm">Improve by voting & participating</p>
            <Progress
              value={85}
              className={`h-2 ${theme === "dark" ? "bg-zinc-800" : "bg-gray-200"}`}
              indicatorClassName={theme === "dark" ? "bg-[#be9244]" : "bg-amber-500"}
            />
          </div>
        </div>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
          <div
            className={`rounded-lg p-6 border flex items-center ${
              theme === "dark" ? "bg-zinc-900 border-zinc-800" : "bg-white border-gray-200"
            }`}
          >
            <div className={`p-3 rounded-full mr-4 ${theme === "dark" ? "bg-zinc-800" : "bg-gray-100"}`}>
              <DollarSign className="h-6 w-6 text-green-500" />
            </div>
            <div>
              <p className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>Treasury Health</p>
          ...
          >
            <div className={`p-3 rounded-full mr-4 ${theme === "dark" ? "bg-zinc-800" : "bg-gray-100"}`}>
              <Coins className={`h-6 w-6 ${theme === "dark" ? "text-[#be9244]" : "text-amber-500"}`} />
            </div>
            <div>
              <p className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>Total SPA Staked</p>
          ...
          >
            ...
            <div>
              <p className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>Member Count</p>
          ...
          >
            ...
            <div>
              <p className={`text-sm ${theme === "dark" ? "text-zinc-400" : "text-gray-600"}`}>Governance Rate</p>
